...
namespace ProjectSynth.Survivors.Synth
{
    public class SynthSurvivor : SurvivorBase<SynthSurvivor>
    {
        ...
        {
            AddHitboxes();
            //bodyPrefab.AddComponent<SynthWeaponComponent>();
        ...
        public override void InitializeEntityStateMachines() 
        {
            ...
            Prefabs.AddMainEntityStateMachine(bodyPrefab, "Body", typeof(SynthMainState), typeof(EntityStates.SpawnTeleporterState));
        ...
        private void AddPassiveSkill()
        {
            ...
            passiveSkillDef1.skillDescriptionToken = SYNTH_PREFIX + "FIRST_PASSIVE_DESCRIPTION";
            passiveSkillDef1.skillName = "M1K-U";
            passiveSkillDef1.skillNameToken = SYNTH_PREFIX + "FIRST_PASSIVE_NAME";

            passiveSkillDef1.activationState = new EntityStates.SerializableEntityStateType(typeof(EntityStates.Idle));
            ...
            passiveSkillDef2.skillDescriptionToken = SYNTH_PREFIX + "SECOND_PASSIVE_DESCRIPTION";
            passiveSkillDef2.skillName = "M1K-U v2.0";
            passiveSkillDef2.skillNameToken = SYNTH_PREFIX + "SECOND_PASSIVE_NAME";

            passiveSkillDef2.activationState = new EntityStates.SerializableEntityStateType(typeof(EntityStates.Idle));
        ...
        private void AddPrimarySkills()
        {
            ...
            SkillDef primarySkillDef1 = Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.ThirtyNineMusic)),
