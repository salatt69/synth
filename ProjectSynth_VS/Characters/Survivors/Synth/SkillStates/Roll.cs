...
namespace ProjectSynth.Survivors.Synth.SkillStates
{
    public class Roll : BaseSkillState, IMetronomeBoostable
    {
        ...
        public static float hiddenInvincibilityDuration = 0.5f;
        ...
        public override void OnEnter()
        {
            ...
            if (MetronomeSequenceManager.TryBeginMetronomeSequence(gameObject)) ApplyMetronomeBoost();
        }
        ...
        public void ApplyMetronomeBoost()
        {
            MetronomeSequenceManager.ExtendDuration();
            hiddenInvincibilityDuration = 60f;
        }
    }
}